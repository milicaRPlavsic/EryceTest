...
export class FormModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (!this.planet) {
      this.form = new FormGroup({
        imageUrl: new FormControl("../../assets/images/planet.jpg"),
        ...
        "distInMillionsKM[fromEarth]": new FormControl(
          null,
          Validators.required
        ),
      });
      ...
      this.form = new FormGroup({
        imageUrl: new FormControl(this.planet.imageUrl),
        ...
        planetRadiusKM: new FormControl(
          this.planet.planetRadiusKM,
          Validators.required
        ),
        planetColor: new FormControl(
          this.planet.planetColor,
          Validators.required
        ),
        "distInMillionsKM[fromSun]": new FormControl(
          this.planet.distInMillionsKM.fromSun,
          Validators.required
        ),
        "distInMillionsKM[fromEarth]": new FormControl(
          this.planet.distInMillionsKM.fromEarth,
          Validators.required
        ),
      });
  ...
  onCreateFormModal() {
    this.planet = {
      ...
      imageUrl: this.filePath ? this.filePath : this.form.get("imageUrl").value,
    };
